...
recMoviesElements.forEach(function (movies) {
    recMoviesWrapper.insertAdjacentHTML('beforeend',
        '<div class="swiper-slide recommended-movies_slider" role="group" aria-label="5 / 7" data-swiper-slide-index="4" style="width: 230px; margin-left: 30px;"><div class= "recommended-item" ><div class="recommended-item_cover"><div class="info"> </div><img class="recommended_movie_img" src="' + movies.coverMovie + '" alt=""></div><div class="recommended-item_info"><div class="recommended-item_info_time"><span>' + movies.durationMovie + '</span></div><div class="recommended-item_info_metha"><p>' + movies.score + '</p></div></div><span class="recommended-item_name">' + movies.nameMovie + '</span></div> </div>')
})
recSerialElements.forEach(function (movies) {
    recSerialsWrapper.insertAdjacentHTML('beforeend',
        '<div class="swiper-slide recommended-serial_slider" role="group" aria-label="3 / 7" data-swiper-slide-index="2" style="width: 230px; margin-left: 30px;"><div class= "recommended-serial-item" ><div class="recommended-item_cover"><img class="recommended_serial_img" src="' + movies.coverMovie + '" alt=""></div><div class="recommended-item_info"><div class="recommended-item_info_time"><span>' + movies.durationMovie + '</span></div><div class="recommended-item_info_metha"><p>' + movies.score + '</p></div></div><span class="recommended-item_name">' + movies.nameMovie + '</span> </></div>'
    )
})
recAnimationlElements.forEach(function (animation) {
    recAnimationsWrapper.insertAdjacentHTML('beforeend',
        '<div class="swiper-slide recommended_animation_slider" role="group" aria-label="3 / 7" data-swiper-slide-index="2" style="width: 230px; margin-left: 30px;"><div class= "recommended-animation-item" ><div class="recommended-animation-item_cover"><img class="recommended_animation_img" src="' + animation.coverMovie + '" alt=""></div><div class="recommended-animation-item_info"><div class="recommended-animation-item_info_time"><span>' + animation.durationMovie + '</span></div><div class="recommended-animation-item_info_metha"><p>' + animation.score + '</p></div></div> <span class="recommended-animation-item_name">' + animation.nameMovie + '</span> </ ></div>'
    )
})
recActionlElements.forEach(function (action) {
    recActionWrapper.insertAdjacentHTML('beforeend',
        ' <div class="swiper-slide recommended-action-slider" role="group" aria-label="4 / 6" data-swiper-slide-index="3" style="width: 230px; margin-left: 30px;"><div class= "recommended-action-item" ><div class="recommended-action-item_cover"><img class="recommended_action_img" src="' + action.coverMovie + '" alt=""></div><div class="recommended-action-item_info"><div class="recommended-action-item_info_time"><span>' + action.durationMovie + '</span></div><div class="recommended-action-item_info_metha"><p>' + action.score + '</p></div></div><span class="recommended-action-item_name">' + action.nameMovie + '</span></ ></div> '
    )
})
recDramalElements.forEach(function (drama) {
    recDramaWrapper.insertAdjacentHTML('beforeend',
        '<div class="swiper-slide swiper-drma-sliders" role="group" aria-label="1 / 7" data-swiper-slide-index="0" style="width: 230px; margin-left: 30px;"><div class= "recommended-drama-item" ><div class="recommended-drama-item_cover"><img class="recommended_drama_img" src="' + drama.coverMovie + '" alt=""></div><div class="recommended-drama-item_info"><div class="recommended-drama-item_info_time"><span>' + drama.durationMovie + '</span></div><div class="recommended-drama-item_info_metha"><p>' + drama.score + '</p></div></div><span class="recommended-drama-item_name">' + drama.nameMovie + '</span></></div> '
    )
})
recComedylElements.forEach(function (comedy) {
    recComedyWrapper.insertAdjacentHTML('beforeend',
        '<div class="swiper-slide recommended-serial_slider" role="group" aria-label="3 / 7" data-swiper-slide-index="2" style="width: 230px; margin-left: 30px;"><div class= "recommended-serial-item" ><div class="recommended-item_cover"><img class="recommended_serial_img" src="' + comedy.coverMovie + '"alt=""></div><div class="recommended-item_info"><div class="recommended-item_info_time"><span>' + comedy.durationMovie + '</span></div><div class="recommended-item_info_metha"><p>' + comedy.score + '</p></div></div><span class="recommended-item_name">' + comedy.nameMovie + '</span> </></div>'
    )
})
recScarylElements.forEach(function (scary) {
    recScaryyWrapper.insertAdjacentHTML('beforeend',
        '<div class="swiper-slide swiper-scary-sliders swiper-slide-active" role="group" aria-label="1 / 7" data-swiper-slide-index="0" style="width: 230px; margin-left: 30px;"><div class="recommended-scary-item"><div class="recommended-scary-item_cover"><img class="recommended_scary_img" src="' + scary.coverMovie + '" alt=""></div><div class="recommended-scary-item_info"><div class="recommended-scary-item_info_time"><span>' + scary.durationMovie + '</span></div><div class="recommended-scary-item_info_metha"><p>' + scary.score + '</p></div></div><span class="recommended-scary-item_name">' + scary.nameMovie + '</span></div></div>'
    )
})
